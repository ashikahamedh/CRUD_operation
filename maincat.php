...
<div class="modal" tabindex="-1" role="dialog" id='modal_frm'>
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class='form-group'>
        ...
        <input type='text' name='category' id='name' required class='form-control'>
      </div>
  ...
  <div class='container mt-5'>
      <p class='text-right'><a href='#' class='btn btn-success' id='add_record'>Add Category</a></p>
    ...
    <tbody id='tbody'>
      <?php 
        ...
        $sql="select * from maincategory ORDER BY category ASC";
        $res=$con->query($sql);
